    ...
    <html lang="en">
      <body className="min-h-screen bg-background font-sans text-foreground antialiased">
        <div className="flex min-h-screen flex-col items-center justify-center px-6 text-center">
          ...
          <button
            onClick={reset}
            className="mt-8 inline-flex h-11 items-center justify-center rounded-sm bg-ink-950 px-6 text-[13px] font-medium uppercase tracking-[0.12em] text-bone-50 transition-colors hover:bg-ink-800"
          >
            Try Again
          </button>
        </div>
