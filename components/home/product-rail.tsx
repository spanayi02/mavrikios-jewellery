  ...
  return (
    <section className={`py-20 sm:py-28 ${tinted ? "bg-marble-100" : ""}`}>
      <div className="container-mavrikios">
        ...
        <Reveal
          stagger={0.1}
          className="-mx-5 flex snap-x snap-mandatory gap-5 overflow-x-auto px-5 pb-2 sm:mx-0 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-10 sm:overflow-visible sm:px-0 lg:grid-cols-4"
        >
